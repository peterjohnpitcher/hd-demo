        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 safe-area-inset">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center space-x-4 lg:space-x-8">
              ...
              <a href="/recipes" className="text-gray-700 hover:text-haagen-burgundy transition-colors py-2 px-3 rounded-md hover:bg-gray-50" aria-label="Browse ice cream recipes">Recipes</a>
              <a href="/nutrition" className="text-gray-700 hover:text-haagen-burgundy transition-colors py-2 px-3 rounded-md hover:bg-gray-50" aria-label="View nutrition information">Nutrition</a>
